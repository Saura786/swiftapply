  ...
  async function loginOrSignup() {
    ...
    if (authMode === "signup") {
      ...
      if (error) {
        ...
        alert(
          "Account created successfully. Please check your email inbox and verify your email address before logging in. If you do not see the email, check Spam/Junk."
        );
      ...
      <>
        ...
        <main className="loginPage">
          <div className="loginCard">
            ...
            {authMode === "login" && (
              <button className="switchBtn" onClick={forgotPassword} disabled={authLoading}>
                Forgot Password?
              </button>
            )}
          </div>
